...
export const SELENA_ACTION_REGISTRY = Object.freeze({
    ...
    'workflow.create': Object.freeze({
        label: 'Create Workflow',
        destination: '/studio/apps/workflow-run',
        requiresApproval: false,
        available: true,
        sideEffect: null,
        fields: Object.freeze([]),
    }),
    'workflow.configure': Object.freeze({
    ...
    'workflow.run': Object.freeze({
        ...
        requiresApproval: false,
        available: true,
        sideEffect: 'Starting a workflow does not approve paid generation, publishing, deletion, or scheduling. Each gated step still requires review before it runs.',
        fields: Object.freeze(['workflowId']),
    }),
