...
|---|---|---|---|---|
| Project/scene workspace | Yes — feature branch | No new configuration required | Automated scene/request tests only | No — not deployed |
...
| Design mode | Planned/disabled | Not applicable | Not tested | No |
